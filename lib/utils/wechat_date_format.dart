...
class WeChatDateFormat {
  // millisecondSinceEpoch:要格式化的日期  dayOnly:只展示到天
  static String format(int millisecondSinceEpoch, {bool dayOnly = true}) {
      // 当天日期
    DateTime nowDate = DateTime.now();
    // 传入的日期
    DateTime targetDate = DateTime.fromMillisecondsSinceEpoch(millisecondSinceEpoch);
    String prefix = "";
